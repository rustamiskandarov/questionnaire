//validator
export const VALUE_MUST_BY_STRING = 'Поле должно содержать строку';
export const VALUE_MUST_BY_NUMBER = 'Поле должно содержать цифры';
export const VALUE_MUST_BY_EMAIL_FORMAT = 'Поле должно быть в формате эл.почты например email@email.em';
export const VALUE_MUST_BY_IN_RANGE_VALUE = 'Поле должно быть в диапазоне значений ';
export const FIELD_MUST_BY_NOT_EMPTY = 'Поле не должно быть пустым';
//excaptions
...
export const WRONG_PASSWORD_ERROR = 'Не верный пароль пользователя';
